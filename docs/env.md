...
| `ADMIN_TOKEN`                       | да          | – (обязательное поле) | Токен администратора для заголовка `X-Admin-Token`                               |
| `USER_TOKEN`                        | нет         | – (обязательное поле) | Токен пользователя для заголовка `X-User-Token`                                  |
